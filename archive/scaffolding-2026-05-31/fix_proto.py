...
# Fix reliable.rs - borrow checker issue + unused import
content = r"""//! Reliable transport layer over UDP.
//!
...
Path(r"G:\codex-AI-tools\lan-link\crates\protocol\src\reliable.rs").write_text(content, encoding="utf-8")

# Fix stream.rs - remove unused import
stream_content = r"""//! Stream multiplexing over a single UDP connection.
//!
...
Path(r"G:\codex-AI-tools\lan-link\crates\protocol\src\stream.rs").write_text(stream_content, encoding="utf-8")
print("fixed")
